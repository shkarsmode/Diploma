						...
						for($i = 0; $i < $tmp; $i++){
							...
							if($vars_profit[$i]["profit"] != ''){
									...
									echo '<tr class="table-border">
										...
										<td><font class="gr">+ '.round($vars_profit[$i]["profit"]*$mon).' '.$vars["currency"].'</font></td>
							...
							// 		<td><font class="rd">- '.$vars_cost[$i]["cost"].' '.$vars["currency"].'</font></td>
