(function () {
  var lang = {
    ...
    "ru": {
      ...
      m: ["Січ", "Лют", "Брз", "Кві", "Тра", "Чер", "Лип", "Сер", "Вер", "Жов", "Лис", "Грд"],
      mo: ["Січень", "Лютий", "Березень", "Квітень", "Травень", "Червень", "Липень", "Серпень", "Вересень", "Жовтень", "Листопад", "Грудень"],
      w: "Пн</td><td>Вів</td><td>Ср</td><td>Чт</td><td>Пт</td><td>Сб</td><td>Нд"
    }
  }
  var def = {
    lang: "ru", // en/ru
    ...
    autoOn: 1, autoOff: 1, now: 1, set0: 0, x: 1, hide: 1, to: "", fn: "changeplace"
  }

  function changeplace(i) {
    let input = document.querySelector('#datecheck');
    input.innerText = i;
  }
